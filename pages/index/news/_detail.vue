...
<template>
  <div class="max-w-7xl mx-auto py-0 lg:py-6">
        ...
        <div class="col-span-2 h-auto">
          ...
          <div class="mt-4 md:flex block items-center justify-between">
            <p class="text-green-500 md:text-base text-sm">
              {{ news.category.title[$i18n.locale] }}
            </p>
          </div>
          <div class="flex items-center justify-between mt-6">
            ...
            <p class="text-gray-500 text-base font-medium">
              {{ $tools.getDate(news.created_at) }}
            </p>
          </div>
          <p class="text-gray-700 md:text-base text-sm mt-4">
            {{ news.description[$i18n.locale] }}
          </p>
          <img
          ...
          <div class="my-3 text-base text-gray-700" v-html="news.content[$i18n.locale]" />
          <!-- <p v-if="news.consultantid !== null" class="text-base text-gray-700 font-semibold my-3">
            {{ `${news.consultantid.name ? news.consultantid.name : ''} ${news.consultantid.surname ? news.consultantid.surname : ''}` }}
          </p> -->
        </div>
        <div>
          <div class="border shadow-md p-3 h-auto">
            ...
            <div v-for="(info, index) in otherInfo" :key="index">
              <div class="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-3 pb-2 border-b">
